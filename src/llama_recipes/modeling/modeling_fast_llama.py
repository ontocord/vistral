...
class LlamaFastRotaryEmbedding(nn.Module):
...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.rotary_emb = LlamaFastRotaryEmbedding(
            self.head_dim,
            base=10000,
            interleaved=False,
        )
    ...
    def forward(
        ...
        **kwargs,
        ...
        raise Exception("We only support Flash Attention 2")
...
class LlamaFlashAttention2(LlamaAttention):
    ...
    def forward(
        ...
        **kwargs,
        ...
        past_key_value = (key_states, value_states, past_len+query_states.size(1)) if use_cache else None
